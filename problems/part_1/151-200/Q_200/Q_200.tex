\begin{prob}{200}{\hosi 10\maru}{DMO4th 理4}
次の値を求めよ.
\[
\max_{n\in \mathbb{N}} \min_{a\in \mathbb{R}} \int_{0}^{\frac{\pi}{2}} \left| \cos^n x - a \sin^n 2x \right| dx
\]
\end{prob}
...
\begin{wrapfigure}[7]{r}[0pt]{150pt}
 \includegraphics[width=\linewidth]{../problems/part_1/151-200/Q_200/A_200_1.png}
\end{wrapfigure}
...
%\begin{figure}[H]
% \centering
% \includegraphics[width=0.7\linewidth]{../problems/part_1/151-200/Q_200/A_200_2.png}
%\end{figure}
