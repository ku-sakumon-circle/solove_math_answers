\begin{prob}{013}{\hosi 4}{灘中入試 (2012)}
 合同な二つの三角形を図のように置きます。このときABの長さは何cmですか。
 \begin{center}
  \includegraphics[width=0.6\linewidth]{../problems/part_1/001-050/Q_013/Q_013.jpg}
 \end{center}
\end{prob}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.6\linewidth]{../problems/part_1/001-050/Q_013/A_013.png}
\end{figure}
