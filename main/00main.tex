...
\input{../problems/\qgroup/Q_00\the\value{q}/Q_00\the\value{q}.tex}
\else
\ifnum\value{q}<100
\index{Q.0\the\value{q}}
\input{../problems/\qgroup/Q_0\the\value{q}/Q_0\the\value{q}.tex}
\else
\index{Q.\the\value{q}}
\input{../problems/\qgroup/Q_\the\value{q}/Q_\the\value{q}.tex}
\fi \fi
