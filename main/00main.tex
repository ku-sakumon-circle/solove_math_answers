...
\newcounter{qii}
\setcounter{qii}{0}
\loop \ifnum\value{qii}<\SMMaxUniversityProblemNumber
\stepcounter{qii}

\edef\qiinumber{\number\value{qii}}
\edef\qiigroup{\SMUniversityQuestionGroupFromNumber{\qiinumber}}
\index{Q.2.\qiinumber}
\input{../problems/part_2/\qiigroup/Q_2_\qiinumber/Q_2_\qiinumber.tex}
